		...
		n.forEach(function(e){
			...
			if(n=o[u])
				if(delete o[n.end],n.push(e),n.end=c,a=r[c]){
					...
					delete r[a.start];var s=a===n?n:n.concat(a);
					...
					var s=n.concat(a.map(function(e){return~e}).reverse());
				...
				if (delete r[n.start],n.unshift(e),n.start=u,a=o[u]){
					...
					var f=a.map(function(e){return~e}).reverse().concat(n);
				...
				if(delete r[n.start],n.unshift(~e),n.start=c,a=o[c]){
					...
					delete o[a.end];var f=a===n?n:a.concat(n);
